package api.test;//Using properties files to take endpoints
...
public class User_Test2 {
	...
	public void TestPostUser() {
		...
		Response response = UserEndPoints2.Create_user(user_payload);
	...
	public void TestGetUser() {
		...
		Response response = UserEndPoints2.Get_user(user_payload.getUsername());
	...
	public void TestUpdateUser() {
		...
		Response response = UserEndPoints2.Update_user(user_payload,user_payload.getUsername());
		...
		Response responseAfterUpdate = UserEndPoints2.Get_user(user_payload.getUsername());
		response.then().log().all();
	...
	public void TestDeleteUser() {
		...
		Response response = UserEndPoints2.Delete_user(user_payload.getUsername());
